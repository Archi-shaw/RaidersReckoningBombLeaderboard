...
const GameTimer = ({ intialMinute = 5, initialSecond = 0 }) => {
  ...
  return (
    <div className="flex flex-row items-end justify-between mt-2">
      <div className='text-white text-4xl mx-5 font-serif font-bold'>  LEADERBOARD 🏆 </div>
      <div className="flex mx-7 gap-2">
        <span className="font-dseg7 text-5xl text-orange-600 text-shadow-lg shadow-orange-500/50"> 
